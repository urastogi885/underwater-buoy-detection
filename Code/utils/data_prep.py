...
video = cv2.VideoCapture('/home/sayani_roy/Documents/underwater-buoy-detection/video/detectbuoy.avi')
count = 0
...
while video:
    ...
    if count == 136:
        ...
        directory = '/home/sayani_roy/Documents/underwater-buoy-detection/Code/images/Yellow'
        pts = []
